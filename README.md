    ...
    <style>
        ...
        * {
        ...
        html, body {
            ...
            /* Bật thanh cuộn ngang nếu nội dung màn hình tràn ra ngoài */
            overflow-x: auto;
            overflow-y: auto;
        }
        ...
        #app-screen {
            display: flex;
            width: 100%;
            min-width: 1200px; /* Đảm bảo độ rộng tối thiểu để tạo thanh cuộn ngang khi thu nhỏ trình duyệt */
            min-height: 100vh;
        }
        ...
        .main-content {
            ...
            flex-direction: column;
            min-height: 100vh;
            overflow-x: auto; /* Hiển thị thanh cuộn ngang khi nội dung tràn */
            overflow-y: auto;
        }
    ...
    <script>
        ...
        async function exportKPIWord() {
                ...
                sections: [{
                    ...
                    children: [
                        ...
                        new Paragraph({
                            ...
                            children: [
                                new TextRun({
                                    text: `PHIẾU ĐÁNH GIÁ KẾT QUẢ THỰC HIỆN NHIỆM VỤ (${monthStr.toUpperCase()})`,
                                    bold: true,
                                    font: "Times New Roman",
                                    size: 28
                                })
                        ...
                        new Paragraph({
                            ...
                            children: [
                                new TextRun({
                                    text: `Họ và tên cán bộ: ${kpiTargetUser.toUpperCase()}`,
                                    bold: true,
                                    font: "Times New Roman",
                                    size: 24
                                })
            ...
            Packer.toBlob(doc).then(blob => {
                saveAs(blob, `Bảng_Đánh_Giá_KPI_${kpiTargetUser}_${selectedKpiMonth}.docx`);
            });
        }
    </script>
</body>
